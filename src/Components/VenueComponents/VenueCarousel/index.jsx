    ...
    <div className="relative">
      {images.length > 0 ? (
        <img
          ...
          onError={(e) => {
            e.target.src = "https://via.placeholder.com/800x400?text=No+Image+Available"; // Fallback image
          }}
      ...
      {images.length > 1 && (
        <>
          ...
          >
            <img src={LeftArrow} alt="Previous" className="w-8 h-8" style={{ transform: 'scale(1.5)' }} />
          </button>
          <button
            ...
            style={{ width: '50px', height: '60px' }}
          >
            <img src={RightArrow} alt="Next" className="w-8 h-8" style={{ transform: 'scale(1.5)' }} />
          </button>
        </>
      )}
    </div>
